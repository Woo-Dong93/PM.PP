...
<body>
	...
	<div id="wrapper">
			...
			<div id="header" class="container">
				...
				<div id="menu">
					<ul>
						...
						<li class="current_page_item"><a href="p-borad.jsp"	accesskey="3" title="">P-board</a></li>
		...
		<div id="contents">
			<img src="picture/blogo.png" alt="오류" id="blogo">
			<div id="b_table">
				<table cellpadding="0" cellspacing="0">
					<caption>파티원 구하기</caption>
					<tbody>
						<tr id="tr1">
						...
						<% 
							int i = 0;  //db에서 불러와 등록한다.
							DBManager dbManager = new DBManager();
							List<Bbs> bbs = dbManager.getBbsList("bbs_party");
							if(bbs != null){
								for( Bbs content : bbs ) {
						%>
						<tr>
							...
							<td class="board_list_border"><a class="no-line" href="p-b_write.jsp?no=<%= content.getBbs_idx() %>&bbs_name=bbs_party"><%= content.getTitle() %></a></td>
						...
						<tr>
							...
							<td class="board_list_border">안녕하세요. 골드3티어 이상 듀오구합니다.</td>
				...
				<div id="pageng">
					<form action="">
						<a href="#" class="cursor_btn"><img src="images/pre_btn.gif" alt="" /></a> <a href="#" class="pageng_a">1</a>
						<a href="#"	class="pageng_a">2</a> <a href="#" class="pageng_a">3</a>
						<a href="#" class="pageng_a">4</a> <a href="#" class="pageng_a">5</a>
						<a href="#" class="pageng_a">6</a> <a href="#" class="pageng_a">7</a>
						<a href="#" class="pageng_a">8</a> <a href="#" class="pageng_a">9</a>
						<a href="#" class="cursor_btn"><img src="images/next_btn.gif" alt="" /></a>
					</form>
				</div>
				 -->
				<!--페이징 End-->
				...
				<ul class="btn">
					...
					<li class="btn_middle"><span><a href="p-b_write.jsp">글쓰기</a></span></li>
